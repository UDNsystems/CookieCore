...
// }
import * as graphix from "./drivers/graphix"
import * as lilmouse from "./drivers/lilmous"

////////////////////////////////////////////////////////////// This stuff handles mouse things
export function mouseDown(clientX: i32, clientY: i32): void{
  lilmouse._ondown(clientX, clientY)
}

export function mouseMove(clientX: i32, clientY: i32): void{
  lilmouse._onmove(clientX, clientY)
}

export function mouseUp(clientX: i32, clientY: i32): void{
  lilmouse._onup(clientX, clientY)
}
/////////////////////////////////////////////////////////////
...
export function main(): i32 {
  ...
  graphix.init()
  graphix.fill("#ff0000")
  graphix.stroke("#00ffff")
  graphix.strokeWidth(20)
  graphix.rect(50,50,50,50)
  return 0;
}